...
class AirbnbSpider(Spider):
	...
	def parse(self, response):
		...
		URL_frag1 = r"https://www.airbnb.com/s/Denver--CO--United-States/homes?refinement_paths%5B%5D=%2Fhomes&allow_override%5B%5D=&price_max="
		...
		URL_frag2 = r"&price_min="
		URL_frag3 = r"&s_tag=Dsga8HCj"
